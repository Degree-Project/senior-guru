...
const { getAllServices, getServices, getServiceDetails, createService, deleteService } = require('../controllers/serviceController');
...
router.route('/services/all').get(getServices);
